...
export const LeaderTeamsPage = ({data}) => {
                ...
                <Card className="mt-5">
                    <Card.Body>
                        ...
                        <div style={{textAlign: 'center'}}>
                            <Button variant="primary" className="search_team"><a href={`/teams`}>Создать
                                команду</a></Button>
                        </div>
                    </Card.Body>
                </Card>
                                ...
                                <div className="col-xl-9" border="primary">
                                    ...
                                    <Card.Body>
                                        ...
                                        <div className="d-flex">
                                            <Button variant="primary" className="check_team"><a href={`/detail-leader-team/${team._id}`}>Просмотр команды</a></Button>
