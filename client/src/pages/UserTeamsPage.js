...
export const UserTeamsPage = ({data}) => {
    console.log(data)
                ...
                <Card className="mt-5">
                    <Card.Body>
                        <Card.Text style={{textAlign: 'center'}}>
                            Вы ещё не состоите в команде
                        </Card.Text>
                        <div style={{textAlign: 'center'}}>
                            <Button variant="primary" className="search_team"><a href={'/teams'}>Найти
                                команду</a></Button>
                        </div>
                    </Card.Body>
                </Card>
                        ...
                        <>
                            <div className="row mt-5">
                                <div className="col-xl-3">
                                    <Card.Img src={team.img == "" ? image : team.img}/>
                                </div>
                                <div className="col-xl-9" border="primary">
                                    <Card.Header as="h5">Название: {team.team_name}</Card.Header>
                                    <Card.Body>
                                        <Card.Text>
                                            Описание: {team.description}
                                        </Card.Text>
                                        <div className="d-flex">
                                            <Button variant="info" className="check_team"><a href={`/detail-user-team/${team._id}`}>Просмотр команды</a></Button>
