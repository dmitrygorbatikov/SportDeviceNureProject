...
export const DetailUserTeamCard = ({ data }) => {
    ...
    const deleteUser = async () => {
        try{
            ...
            const fetched = await request(`/api/team/remove-user-from-team?id=${data._id}`, 'POST', null, {
                Authorization: `Bearer ${token}`
            })

            history.push(`/my-teams/${userId}`)
        ...
        <>
            <div className="row mt-5">
                <div className="col-xl-3">
                    <Card.Img src={data.img == "" ? image : data.img}/>
                </div>
            ...
            <Card className="mt-5" border="dark">
                <Card.Header >Игроки команды</Card.Header>
            </Card>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Покинуть команду</Modal.Title>
                </Modal.Header>
                <Modal.Body>Вы уверены, что хотите это сделать? Вступить заново можно будет после подтверждения капитана команды</Modal.Body>
                <Modal.Footer>
            ...
            <Button variant="danger" onClick={handleShow}>Покинуть команду</Button>
        </>
    )
}